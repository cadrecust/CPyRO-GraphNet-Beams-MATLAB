function [volRebarSpans,LenRebarL,LenRebarM,LenRebarR,sepRebarSpans,db9Spans,...
  ...
  load_conditions,fy,wac,cutxLoc,Wfac,pltOptConv,pltOptReb,span2Plt,Niter,Nparticles)
...
for i=1:nspans
    ...
    (b(i),h(i),span(i),brec,hrec,hagg,pmin,pmax,rebarAvailable,fcu,load_conditions(i,:),...
    fy,wac,cutxLoc(i,:),bestdbc(1,3),bestnbtLMR(1,7:9),dblowRight,...
    nblowRight,Wfac,pltOptConv,i,Niter,Nparticles);
