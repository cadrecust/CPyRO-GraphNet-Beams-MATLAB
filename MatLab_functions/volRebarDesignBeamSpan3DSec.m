function [volRebar,lenRebarL,lenRebarM,lenRebarR]=volRebarDesignBeamSpan3DSec...
  (nb3l,nb3m,nb3r,abl3,abm3,abr3,ldL3,ld3M,ld3R,nbAfterCut3L,nbAfterCut3M,...
  cutLoc,span)

%% Total length of bars (considering cuts)
[lbarL1,lbarL2,lbarL3]=lenRebarRecBeamCuts3DSec(nb3l,...
    nbAfterCut3L,span,ldL3+cutLoc(1));
[lbarM1,lbarM2,lbarM3]=lenRebarRecBeamCuts3DSec(nb3m,...
    nbAfterCut3M,span,ld3M.*2+cutLoc(3)-cutLoc(2));
[lbarR1,lbarR2,lbarR3]=lenRebarRecBeamCuts3DSec(nb3r,...
