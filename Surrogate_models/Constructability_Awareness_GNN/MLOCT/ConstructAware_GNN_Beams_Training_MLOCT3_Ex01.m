...
% third amount of lightest rebar weight (MLOCT3), according to a database where
...
if doTraining
    ...
    paramNL=load('nLay_GNN_MOConstrucT3_4000.mat');
    nheadsparamnNLGNN=load('nHead_nLay_GNN_MOConstrucT3_4000.mat');
end
%% Test model
